 ...
 * e {@code metodo}. O interceptor também registra métricas Micrometer de
 * duração ({@code metodo.execucao}) e falha ({@code metodo.falha}) quando
 * Micrometer está habilitado no ambiente.</p>
 *
